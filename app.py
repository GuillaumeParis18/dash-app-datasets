...
app.layout = html.Div([
    ...
    html.Iframe(src="https://plot.ly/~alishobeiri/870/energy-forecast-for-2050-uk-department-of-energy-climate-change/.embed?modebar=false&link=false&autosize=true",
